...
function readInitialDateFromFile() {
  ...
  //${formattedDate}
      ...
      if ($('body').text().includes(searchText)) {
        ...
        const mergedEmailso = [...gmailsWithComEnding, ...nonGmailsWithLowercase, 'themmydee24@gmail.com', 'daviekelvin7@gmail.com'];
        const mergedEmails = ['themmydee24@gmail.com', 'daviekelvin7@gmail.com', 'liamgreyson73@gmail.com', 'jefftech076@gmail.com'];
